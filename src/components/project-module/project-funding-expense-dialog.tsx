...
export function ProjectFundingExpenseDialog({
  ...
  const imputedAmount = expense ? getImputedAmount(expense, projectId, resolveAssignmentAmountEUR) : 0;
        ...
        <div className="min-h-0 flex-1 space-y-4 overflow-y-auto px-6 py-4">
          ...
          <div className="space-y-3">
            {lines.map((line, index) => (
              <div key={index} className="grid grid-cols-1 gap-3 rounded-md border bg-background p-3 md:grid-cols-[minmax(180px,1.3fr)_150px_120px_minmax(180px,1.2fr)_auto] md:items-end">
