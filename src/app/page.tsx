    ...
    <main className="flex min-h-screen flex-col">
      ...
      <section id="que-resol-summa-social" className="px-6 py-10">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-6">Què resol Summa Social?</h2>
          ...
          <div className="space-y-4 text-muted-foreground">
            ...
            <p>
              <strong className="text-foreground">Fiscalitat a temps real:</strong> Models 182 i 347
              amb un clic. Certificats de donació generats i enviats automàticament. Tot validat i
              llest per enviar a la gestoria o l&apos;AEAT.
            </p>

            <p>
              <strong className="text-foreground">Remeses de quotes i pagaments:</strong> Divideix
              automàticament les remeses agrupades del banc. Genera fitxers SEPA per pagaments a
              proveïdors i nòmines.
            </p>

            <p>
              <strong className="text-foreground">Visió clara i actualitzada:</strong> Dashboard amb
              mètriques en temps real. Ingressos, despeses, balanç i alertes, tot visible d&apos;un
              cop d&apos;ull. Informes automàtics per a junta o patronat.
            </p>
            ...
            <p>
              <strong className="text-foreground">El resultat:</strong> més temps per a la missió de
              l&apos;entitat, menys temps amb fulls de càlcul i tasques repetitives. Gestió econòmica
              professional, accessible i sense complicacions.
            </p>
          </div>
        </div>
      </section>
