  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col">
        ...
        <div className="flex flex-col items-center justify-center bg-background px-6 py-16">
          <div className="w-full max-w-3xl text-center space-y-8">
            ...
            <div className="space-y-4">
              ...
              {/* Solució */}
              <p className="text-sm text-foreground/90 font-medium max-w-xl mx-auto">
            ...
            <ul className="text-left space-y-3 mx-auto max-w-lg">
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm text-muted-foreground">
                  Deixes de &quot;perseguir&quot; factures, tiquets i nòmines: tot queda al
                  mateix lloc, amb traçabilitat.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-primary shrink-0 mt-0.5" />
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-4 max-w-2xl mx-auto mb-8">
              <p className="text-sm text-muted-foreground">
                <strong className="text-foreground">El problema:</strong>{' '}
                La feina administrativa s&apos;encalla quan has d&apos;entrar al banc i fer
                pagaments un a un, quan tens nòmines i factures agrupades, o quan has de fer
                reemborsaments i liquidacions a persones.
              </p>
              <p className="text-sm text-muted-foreground">
                <strong className="text-foreground">La solució:</strong>{' '}
                Amb Summa Social puges factures i nòmines, les revises, i generes una remesa
                de pagament agrupada per pujar al banc. Per tiquets i viatges, generes liquidacions
        ...
        <section className="px-6 py-16">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-4 max-w-2xl mx-auto mb-8">
              <p className="text-sm text-muted-foreground">
                <strong className="text-foreground">El problema:</strong>{' '}
                Quan el banc ingressa una remesa, tens un únic import agregat i perds el
                detall de qui ha pagat. I quan hi ha devolucions, el gener et rebenta:
                imports inflats, certificats incorrectes i discussions amb donants.
              </p>
              <p className="text-sm text-muted-foreground">
                <strong className="text-foreground">La solució:</strong>{' '}
                Summa Social desglossa remeses en quotes individuals, identifica socis i
                manté el detall necessari. Les devolucions queden registrades i aplicades
                al càlcul anual, perquè el certificat i el Model 182 reflecteixin el que
        ...
        <section className="bg-muted/30 px-6 py-16">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-4 max-w-2xl mx-auto mb-8">
              <p className="text-sm text-muted-foreground">
                <strong className="text-foreground">El problema:</strong>{' '}
                El gener no falla: falta DNI, falta CP, hi ha devolucions pendents,
                i acabes muntant Excel a corre-cuita per enviar a la gestoria.
              </p>
              <p className="text-sm text-muted-foreground">
                <strong className="text-foreground">La solució:</strong>{' '}
                Summa Social t&apos;assenyala què falta i et genera els exports fiscals
                perquè tu només hagis d&apos;enviar a la gestoria un fitxer net, traçable
                i coherent amb el banc.
              </p>
            </div>

            <div className="max-w-xl mx-auto">
              <h3 className="font-semibold text-sm mb-3">Què envies a la gestoria:</h3>
        ...
        {/* Bloc — Si fas cooperació internacional */}
        <section className="px-6 py-16">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold text-center mb-6">
            ...
            <div className="space-y-4 max-w-2xl mx-auto mb-8">
              ...
              <p className="text-sm text-muted-foreground">
                <strong className="text-foreground">La solució:</strong>{' '}
                El mòdul de projectes connecta despesa real amb projecte i partida, mostra
                execució pressupostària i incorpora un assistent per quadrar justificacions
                abans d&apos;exportar.
              </p>
            </div>
