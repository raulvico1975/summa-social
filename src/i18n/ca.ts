export const ca = {
  ...
  movements: {
    ...
    table: {
      ...
      originalDonation: "Donació original",
      ...
      noLink: "Deixar pendent de revisió",
      linkedDonationInfo: "La donació vinculada serà marcada com \"Retornada\" i exclosa del Model 182.",
      returnLinkPendingInfo: "Es guardarà com a pendent de revisió. Assignar el donant no valida el vincle fiscal amb la donació original.",
      noteLabel: "Nota",
  ...
  importers: {
    ...
    transaction: {
      ...
      errors: {
        ...
        unsupportedFormatDescription: "Si us plau, puja un fitxer .csv, .xlsx o .xls",
        cannotReadCsv: "No s'ha pogut llegir l'arxiu CSV.",
        emptyXlsx: "El fitxer Excel està buit o no té un format vàlid.",
        ...
        cannotProcessXlsx: "No s'ha pogut processar el fitxer Excel.",
  ...
  donors: {
    ...
    confirmDeleteDescription: "El donant s'enviarà a Eliminats. El podràs restaurar més endavant.",
    ...
    donorDeletedDescription: (name: string) => `El donant "${name}" s'ha enviat a Eliminats.`,
    donorRestored: "Donant restaurat",
    donorRestoredDescription: (name: string) => `El donant "${name}" s'ha restaurat correctament.`,
    ...
    donorReactivated: "Donant reactivat",
    donorReactivatedDescription: (name: string) => `El donant "${name}" ha estat reactivat.`,
    cannotDeleteWithTransactions: "Aquest donant no es pot eliminar perquè té moviments associats.",
    deletedDuplicateTitle: "Ja existeix un donant eliminat",
    deletedDuplicateDescription: "Ja existeix un donant eliminat amb aquestes dades.",
    noDeletedData: "No hi ha donants eliminats",
    noDeletedDataDescription: "Quan eliminis un donant sense moviments associats, el trobaràs aquí i el podràs restaurar.",
    viewDeleted: "Veure Eliminats",
  ...
  certificates: {
    ...
    pdf: {
      ...
      donorNetBodyWithAddress: (donorName: string, donorTaxId: string, donorAddress: string, year: string, amount: string) =>
        `Que ${donorName}, amb NIF/CIF ${donorTaxId} i domicili a ${donorAddress}, ha efectuat donacions dineràries a favor d'aquesta entitat durant l'exercici fiscal ${year}, per un import net total de ${amount}.`,
      donorNetBody: (donorName: string, donorTaxId: string, year: string, amount: string) =>
        `Que ${donorName}, amb NIF/CIF ${donorTaxId}, ha efectuat donacions dineràries a favor d'aquesta entitat durant l'exercici fiscal ${year}, per un import net total de ${amount}.`,
