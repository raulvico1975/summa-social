export const ca = {
  ...
  reports: {
    ...
    exportGestoria: "Exportar plantilla gestoria (A–G)",
    exportGestoriaTooltip: "Format simplificat per gestoria. No substitueix l'export estàndard.",
    exportAEAT: "Export AEAT (fitxer oficial)",
