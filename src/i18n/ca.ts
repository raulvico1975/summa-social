export const ca = {
  ...
  dangerZone: {
    ...
    // Test remittance deletion
    testRemittanceSection: "Eines temporals per esborrar dades de prova",
    deleteTestRemittance: "Esborrar transaccions de remesa de prova",
    deleteTestRemittanceDescription: "Cerca i esborra transaccions generades per remeses de prova (data 2025-12-09)",
    noTestRemittances: "No s'han trobat remeses de prova",
    noTestRemittancesDescription: "No hi ha transaccions de remesa de prova per esborrar.",
    searchError: "Error en la cerca",
    confirmTestRemittanceTitle: "Confirmar esborrat de remeses de prova",
    confirmTestRemittanceDescription: (count: number) => `S'han trobat ${count} transaccions de remesa de prova. Estàs segur que vols esborrar-les?`,
    testRemittanceTransactions: "transaccions de remesa de prova",
  },
  donorSearchCombobox: {
