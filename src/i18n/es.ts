export const es = {
  ...
  movements: {
    ...
    table: {
      ...
      delete: "Eliminar",
      confirmDeleteTransactionTitle: "Eliminar movimiento",
      confirmDeleteTransactionDescription: "Este movimiento se eliminará permanentemente. Esta acción no se puede deshacer.",
      ...
      originalDonation: "Donación original",
      ...
      noLink: "Dejar pendiente de revisión",
      linkedDonationInfo: "La donación vinculada será marcada como \"Devuelta\" y excluida del Modelo 182.",
      returnLinkPendingInfo: "Se guardará como pendiente de revisión. Asignar el donante no valida el vínculo fiscal con la donación original.",
      noteLabel: "Nota",
  ...
  importers: {
    ...
    transaction: {
      ...
      errors: {
        ...
        unsupportedFormatDescription: "Por favor, sube un archivo .csv, .xlsx o .xls",
        cannotReadCsv: "No se pudo leer el archivo CSV.",
        emptyXlsx: "El archivo Excel está vacío o no tiene un formato válido.",
        ...
        cannotProcessXlsx: "No se pudo procesar el archivo Excel.",
  ...
  donors: {
    ...
    confirmDeleteDescription: "El donante se enviará a Eliminados. Podrás restaurarlo más adelante.",
    ...
    donorDeletedDescription: (name: string) => `El donante "${name}" se ha enviado a Eliminados.`,
    donorRestored: "Donante restaurado",
    donorRestoredDescription: (name: string) => `El donante "${name}" se ha restaurado correctamente.`,
    ...
    donorReactivated: "Donante reactivado",
    donorReactivatedDescription: (name: string) => `El donante "${name}" ha sido reactivado.`,
    cannotDeleteWithTransactions: "Este donante no se puede eliminar porque tiene movimientos asociados.",
    deletedDuplicateTitle: "Ya existe un donante eliminado",
    deletedDuplicateDescription: "Ya existe un donante eliminado con estos datos.",
    noDeletedData: "No hay donantes eliminados",
    noDeletedDataDescription: "Cuando elimines un donante sin movimientos asociados, lo verás aquí y podrás restaurarlo.",
  ...
  donorDetail: {
    ...
    previous: "Anterior",
    next: "Siguiente",
    invalidFiscalYear: "Año fiscal no válido",
    annualCertificateFilterMismatch: (year: string) => `Selecciona el año ${year} en el filtro antes de generar o enviar el certificado anual.`,
    annualCertificateOutOfSync: "Los datos de la ficha y del certificado no están alineados. Recarga e inténtalo de nuevo.",
    certificate: {
      ...
      donorAddressMissing: "[Domicilio no informado]",
      fiscalSummary: "Resumen fiscal:",
      receivedDonations: "Donaciones recibidas:",
      processedReturns: "Devoluciones efectuadas:",
      certifiedNetAmount: "Importe neto certificado:",
    },
