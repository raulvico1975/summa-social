export const es = {
  ...
  dangerZone: {
    ...
    testRemittanceSection: "Herramientas temporales para borrar datos de prueba",
    deleteTestRemittance: "Borrar transacciones de remesa de prueba",
    deleteTestRemittanceDescription: "Busca y borra transacciones generadas por remesas de prueba (fecha 2025-12-09)",
    noTestRemittances: "No se han encontrado remesas de prueba",
    noTestRemittancesDescription: "No hay transacciones de remesa de prueba para borrar.",
    searchError: "Error en la búsqueda",
    confirmTestRemittanceTitle: "Confirmar borrado de remesas de prueba",
    confirmTestRemittanceDescription: (count: number) => `Se han encontrado ${count} transacciones de remesa de prueba. ¿Estás seguro de que quieres borrarlas?`,
    testRemittanceTransactions: "transacciones de remesa de prueba",
  },
  donorSearchCombobox: {
