export const fr = {
  ...
  movements: {
    ...
    table: {
      ...
      readyToCountIn182: "Prêt pour le 182",
      markAsDonation182: "Faire compter au 182",
      removeFrom182: "Retirer du 182",
      fiscalDonation: "Don fiscal",
      ...
      returnInfo: "Rejet",
      originalDonation: "Don d'origine",
      loadingDonations: "Chargement des dons...",
      noDonationsFound: "Aucun don trouvé pour ce donateur.",
      linkToDonation: "Lier à un don...",
      noLink: "Laisser en attente de révision",
      linkedDonationInfo: "Le don lié sera marqué « Rejeté » et exclu du Modèle 182.",
      returnLinkPendingInfo: "Le rejet sera enregistré comme en attente de révision. Attribuer le donateur ne valide pas le lien fiscal avec le don d'origine.",
      noteLabel: "Note",
  ...
  importers: {
    ...
    transaction: {
      ...
      errors: {
        ...
        unsupportedFormatDescription: "Veuillez télécharger un fichier .csv, .xlsx ou .xls",
        cannotReadCsv: "Impossible de lire le fichier CSV.",
        emptyXlsx: "Le fichier Excel est vide ou n'a pas un format valide.",
        ...
        cannotProcessXlsx: "Impossible de traiter le fichier Excel.",
  ...
  donors: {
    ...
    confirmDeleteDescription: "Le donateur sera envoyé dans Éliminés. Vous pourrez le restaurer plus tard.",
    ...
    donorDeletedDescription: (name: string) => `Le donateur « ${name} » a été envoyé dans Éliminés.`,
    donorRestored: "Donateur restauré",
    donorRestoredDescription: (name: string) => `Le donateur « ${name} » a été restauré avec succès.`,
    ...
    donorReactivated: "Donateur réactivé",
    donorReactivatedDescription: (name: string) => `Le donateur « ${name} » a été réactivé.`,
    cannotDeleteWithTransactions: "Ce donateur ne peut pas être supprimé car il a des mouvements associés.",
    deletedDuplicateTitle: "Un donateur supprimé existe déjà",
    deletedDuplicateDescription: "Un donateur supprimé avec ces données existe déjà.",
    noDeletedData: "Aucun donateur supprimé",
    noDeletedDataDescription: "Quand vous supprimerez un donateur sans mouvements associés, il apparaîtra ici et vous pourrez le restaurer.",
    viewDeleted: "Voir Éliminés",
  ...
  donorDetail: {
    ...
    previous: "Précédent",
    next: "Suivant",
    invalidFiscalYear: "Exercice fiscal non valide",
    annualCertificateFilterMismatch: (year: string) => `Sélectionnez l'année ${year} dans le filtre avant de générer ou d'envoyer l'attestation annuelle.`,
    annualCertificateOutOfSync: "Les données de la fiche et de l'attestation ne sont pas alignées. Rechargez puis réessayez.",
    certificate: {
      ...
      donorAddressMissing: "[Domicile non renseigné]",
      fiscalSummary: "Résumé fiscal :",
      receivedDonations: "Dons reçus :",
      processedReturns: "Rejets effectués :",
      certifiedNetAmount: "Montant net attesté :",
    },
