...
describe('sepa index exports', () => {
  ...
  it('exports pain.008 helpers from pain008 index', () => {
    ...
    assert.equal(typeof pain008.parsePain008, 'function');
    assert.equal(typeof pain008.isPain008File, 'function');
