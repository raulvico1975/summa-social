...
const DONATION_CERTIFICATES_CONTENT_CA: PublicLandingContent = {
  hero: {
    ...
    media: {
      type: 'video',
      src: '/media/landing-pages/certificats-donacio/video/certificats-donacio-demo-2026-04-28.mp4',
      poster: '/media/landing-pages/certificats-donacio/stills/certificats-donacio-demo-2026-04-28-poster.webp',
      durationLabel: '58 s',
      autoPlay: false,
      loop: false,
      controls: true,
      muted: false,
      alt: 'Vídeo demostratiu del procés de certificats de donació a Summa Social',
    },
  },
  visualProof: {
    ...
    items: [
      {
        ...
        imageSrc: '/media/features/gestio-donants/stills/fitxa-fiscal-start.webp',
      ...
      },
      {
        ...
        imageSrc: '/media/features/certificats-donacio/stills/certificats-start.webp',
      ...
      },
      {
        ...
        imageSrc: '/media/features/model-347-ong/stills/excel-gestoria-start.webp',
...
const DONATION_CERTIFICATES_CONTENT_ES: PublicLandingContent = {
  hero: {
    ...
    media: {
      ...
      controls: true,
      muted: false,
      alt: 'Vídeo demostrativo del proceso de certificados de donación en Summa Social',
    },
  },
  visualProof: {
...
const SEPA_REMITTANCES_CONTENT_CA: PublicLandingContent = {
  hero: {
    ...
    media: {
      ...
      poster: '/media/landing-pages/remeses-sepa/stills/remeses-sepa-demo-2026-04-28-poster.webp',
    ...
    items: [
      {
        ...
        imageSrc: '/media/features/remeses-sepa/stills/divisor-remeses-start.webp',
      ...
      },
      {
        ...
        imageSrc: '/media/features/remeses-sepa/stills/devolucions-start.webp',
...
const BANK_STATEMENT_IMPORT_CONTENT_CA: PublicLandingContent = {
  hero: {
    ...
    media: {
      type: 'video',
      src: '/media/landing-pages/importar-extracte-bancari/video/importar-extracte-bancari-demo-ca.mp4',
      poster: '/media/landing-pages/importar-extracte-bancari/stills/importar-extracte-bancari-demo-poster.webp',
      captionsSrc: '/media/landing-pages/importar-extracte-bancari/video/importar-extracte-bancari-demo-ca.vtt',
      captionsLang: 'ca',
    ...
    items: [
      {
        ...
        imageSrc: '/media/features/importar-extracte-bancari/stills/import-extractes-preimport.webp',
      ...
      },
      {
        ...
        imageSrc: '/media/features/conciliacio-bancaria/stills/classificacio-auto.webp',
...
const BANK_STATEMENT_IMPORT_CONTENT_ES: PublicLandingContent = {
  hero: {
    ...
    media: {
      type: 'video',
      src: '/media/landing-pages/importar-extracte-bancari/video/importar-extracte-bancari-demo-es.mp4',
      poster: '/media/landing-pages/importar-extracte-bancari/stills/importar-extracte-bancari-demo-poster.webp',
      captionsSrc: '/media/landing-pages/importar-extracte-bancari/video/importar-extracte-bancari-demo-es.vtt',
      captionsLang: 'es',
...
const BANK_RECONCILIATION_ONG_CONTENT_CA: PublicLandingContent = {
  hero: {
    ...
    media: {
      type: 'video',
      src: '/media/landing-pages/conciliacio-bancaria-ong/video/conciliacio-bancaria-demo-ca.mp4',
      poster: '/media/landing-pages/conciliacio-bancaria-ong/stills/conciliacio-bancaria-demo-ca-poster.webp',
      durationLabel: '37 s',
...
const BANK_RECONCILIATION_ONG_CONTENT_ES: PublicLandingContent = {
  hero: {
    ...
    media: {
      type: 'video',
      src: '/media/landing-pages/conciliacio-bancaria-ong/video/conciliacio-bancaria-demo-es.mp4',
      poster: '/media/landing-pages/conciliacio-bancaria-ong/stills/conciliacio-bancaria-demo-ca-poster.webp',
      durationLabel: '21 s',
...
const DONATIONS_CONTROL_ONG_CONTENT_CA: PublicLandingContent = {
  hero: {
    ...
    media: {
      ...
      durationLabel: '15 s',
      src: '/media/landing-pages/control-donacions-ong/video/control-donacions-demo-ca.mp4',
      poster: '/media/landing-pages/control-donacions-ong/stills/control-donacions-demo-poster.webp',
      captionsSrc: '/media/landing-pages/control-donacions-ong/video/control-donacions-demo-ca.vtt',
      captionsLang: 'ca',
    ...
    items: [
      {
        ...
        imageSrc: '/media/features/gestio-donants/stills/filtres-socis-start.webp',
...
const DONATIONS_CONTROL_ONG_CONTENT_ES: PublicLandingContent = {
  hero: {
    ...
    media: {
      ...
      durationLabel: '15 s',
      src: '/media/landing-pages/control-donacions-ong/video/control-donacions-demo-es.mp4',
      poster: '/media/landing-pages/control-donacions-ong/stills/control-donacions-demo-poster.webp',
      captionsSrc: '/media/landing-pages/control-donacions-ong/video/control-donacions-demo-es.vtt',
      captionsLang: 'es',
...
const DONOR_MANAGEMENT_CONTENT_CA: PublicLandingContent = {
  hero: {
    ...
    media: {
      type: 'video',
      src: '/media/features/gestio-donants/video/filtres-socis-loop.mp4',
      poster: '/media/features/gestio-donants/stills/filtres-socis-start.webp',
...
const MODEL_347_ONG_CONTENT_CA: PublicLandingContent = {
  hero: {
    ...
    media: {
      type: 'video',
      src: '/media/features/model-347-ong/video/model-347-loop.mp4',
      poster: '/media/features/model-347-ong/stills/model-347-start.webp',
    ...
    items: [
      {
        ...
        imageSrc: '/media/features/model-347-ong/stills/model-347-start.webp',
      ...
      },
      {
        ...
        imageSrc: '/media/features/model-347-ong/stills/model-347-dialog.webp',
...
const RETURNED_RECEIPTS_CONTENT_CA: PublicLandingContent = {
  hero: {
    ...
    media: {
      type: 'video',
      src: '/media/features/remeses-sepa/video/devolucions-loop.mp4',
      poster: '/media/features/remeses-sepa/stills/devolucions-start.webp',
...
const MODEL_182_CONTENT_CA: PublicLandingContent = {
  hero: {
    ...
    media: {
      type: 'video',
      src: '/media/landing-pages/model-182/video/model-182-demo-ca.mp4',
      poster: '/media/landing-pages/model-182/stills/model-182-demo-poster.webp',
      autoPlay: false,
      loop: false,
      durationLabel: '10 s',
  ...
  visualProof: {
    ...
    items: [
      ...
      },
      {
        ...
        imageSrc: '/media/features/model-182/stills/model-182-dialog.webp',
...
const MODEL_182_CONTENT_ES: PublicLandingContent = {
  hero: {
    ...
    media: {
      type: 'video',
      src: '/media/landing-pages/model-182/video/model-182-demo-es.mp4',
      poster: '/media/landing-pages/model-182/stills/model-182-demo-poster.webp',
      autoPlay: false,
      loop: false,
      durationLabel: '10 s',
...
const PROJECT_MANAGEMENT_CONTENT_CA: PublicLandingContent = {
  hero: {
    ...
    media: {
      type: 'video',
      src: '/media/landing-pages/gestio-projectes-justificacio/video/gestio-projectes-demo-2026-04-28.mp4',
      poster: '/media/landing-pages/gestio-projectes-justificacio/stills/gestio-projectes-demo-2026-04-28-poster.webp',
    ...
    items: [
      {
        ...
        imageSrc: '/media/features/projectes-justificacio/stills/pressupost-partides-start.webp',
      ...
      },
      {
        ...
        imageSrc: '/media/features/projectes-justificacio/stills/assignacio-despeses-start.webp',
      ...
      },
      {
        ...
        imageSrc: '/media/features/projectes-justificacio/stills/export-financador-dialog.webp',
...
const CONTROL_VISIBILITY_CONTENT_CA: PublicLandingContent = {
  hero: {
    ...
    media: {
      type: 'video',
      src: '/media/landing-pages/control-visibilitat-entitats/video/control-visibilitat-demo-2026-04-28.mp4',
      poster: '/media/landing-pages/control-visibilitat-entitats/stills/control-visibilitat-demo-2026-04-28-poster.webp',
  ...
  visualProof: {
    ...
    items: [
      ...
      },
      {
        ...
        imageSrc: '/media/features/control-visibilitat-entitats/stills/informe-junta-modal.webp',
      ...
      },
      {
        ...
        imageSrc: '/media/features/control-visibilitat-entitats/stills/exportacio-dades-pdf.webp',
