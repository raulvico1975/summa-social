...
- Reusable camera or layout beats
- Capture-backed action states
- Any shot logic that can be reused across explainer pieces

## What does not belong here
- Research-only experiments
- Final rendered videos
- One-off campaign copy
- Anything that depends on `05` as an approved precedent
