...
El flux real ha de deixar clar el compte correcte, la revisió prèvia, les alertes de conflicte i el resultat operatiu.

## Públic

Persones d'administració, gestió i comptabilitat d'entitats socials.
...
- 5 beats
- entrada a Moviments
- validació del compte
- resum pre-importació
- alerta de conflicte o duplicat
- resultat operatiu
