...
- S'executa automàticament a `.husky/pre-commit` (cap commit passa si falta una clau).
- S'executa dins `scripts/verify-local.sh` (abans del build, al flux de verificació manual).
