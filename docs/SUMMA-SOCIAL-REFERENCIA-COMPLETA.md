...
### 3.4.2 Donants - Camps (ACTUALITZAT v1.7)
...
### 3.4.3 Importador de Donants (ACTUALITZAT v1.7)
...
# ═══════════════════════════════════════════════════════════════════════════════
# FI DEL DOCUMENT
# Última actualització: Desembre 2025 - Versió 1.7
# ═══════════════════════════════════════════════════════════════════════════════
