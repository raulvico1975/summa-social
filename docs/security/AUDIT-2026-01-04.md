...
> ESTAT 2026-03-08: snapshot històric.
> Aquest document reflecteix l'auditoria i les conclusions d'aquella data.
> No s'ha d'interpretar com a descripció exacta de l'estat actual sense contrastar-lo amb els documents vius de seguretat i amb el codi actual.

## Resum Executiu

| Àrea | Estat | Risc Residual |
|------|-------|---------------|
| Storage cross-org | **PASS** | Baix |
...
✅ Smoke tests executats el 10 febrer 2026. Aïllament cross-org verificat.

| # | Usuari | Acció | Esperat | Resultat | Data/Hora |
|---|--------|-------|---------|----------|-----------|
| 1 | UserTest (OrgB) | Write a OrgA | DENY | ✅ DENY HTTP 403 | 2026-02-10 17:46:38 UTC |
| 2 | UserTest (OrgB) | Read a OrgA | DENY | ✅ DENY HTTP 403 | 2026-02-10 17:46:40 UTC |
| 3 | UserTest (OrgB) | Write a OrgB | ALLOW | ✅ ALLOW | 2026-02-10 17:46:42 UTC |
| 4a | SuperAdmin | Write a OrgA | ALLOW | ✅ ALLOW | 2026-02-10 17:48:15 UTC |
| 4b | SuperAdmin | Write a OrgB | ALLOW | ✅ ALLOW | 2026-02-10 17:48:16 UTC |
